...
import 'package:myuzu/CustomWidgets/copy_clipboard.dart';
import 'package:myuzu/CustomWidgets/gradient_containers.dart';
import 'package:myuzu/CustomWidgets/popup.dart';
import 'package:myuzu/CustomWidgets/snackbar.dart';
import 'package:myuzu/CustomWidgets/textinput_dialog.dart';
import 'package:myuzu/Helpers/backup_restore.dart';
import 'package:myuzu/Helpers/config.dart';
// import 'package:myuzu/Helpers/countrycodes.dart';
import 'package:myuzu/Helpers/picker.dart';
import 'package:myuzu/Helpers/supabase.dart';
import 'package:myuzu/Screens/Home/saavn.dart' as home_screen;
import 'package:myuzu/Screens/Settings/player_gradient.dart';
// import 'package:myuzu/Screens/Top Charts/top.dart' as top_screen;
import 'package:myuzu/Services/ext_storage_provider.dart';
import 'package:myuzu/main.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  String autoBackPath = Hive.box('settings').get(
    'autoBackPath',
    defaultValue: '/storage/emulated/0/Myuzu/Backups',
  ) as String;
                        ...
                        ListTile(
                          ...
                          trailing: TextButton(
                            ...
                            onPressed: () async {
                              autoBackPath =
                                  await ExtStorageProvider.getExtStorage(
                                        dirName: 'Myuzu/Backups',
                                      ) ??
                                      '/storage/emulated/0/Myuzu/Backups';
                              Hive.box('settings')
                      ...
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '${AppLocalizations.of(
                                context,
                              )!.shareAppText}: https://github.com/tamletan/Myuzu',
                            );
                          },
                          dense: true,
                        ),
                        ListTile(
                          ...
                          onTap: () {
                            launchUrl(
                              Uri.parse(
                                'https://www.buymeacoffee.com/tamletan',
                              ),
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            const String upiUrl =
                                'upi://pay?pa=tamletan@tama&pn=Myuzu';
                            launchUrl(
                              Uri.parse(upiUrl),
                              mode: LaunchMode.externalApplication,
                            );
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                launchUrl(
                                                  Uri.parse(
                                                    'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dmyuzuyoucantescape%40gmail.com%26subject%3DRegarding%2520Mobile%2520App',
                                                  ),
                                                  mode: LaunchMode
                                                      .externalApplication,
                                                );
